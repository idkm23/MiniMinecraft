...
public abstract class Entity {
    public static final int PLAYER = 40, HURT_PLAYER = 41, HLESS_PLAYER = 42, ZOMBIE = 43, BURNING_ZOMB = 44, HURT_ZOMB = 45, BLOOD = 46, 
            SHEEP = 47, HURT_SHEEP = 48, BASE_MOVE_SPEED = 8, P_DAMAGE1 = 3, Z_DAMAGE1 = 5, SHEEP_BAA = 7; //IDs in the audio/image arrays
    ...
    private final double WIDTH, HEIGHT; //used for collision detection & how large the image should be drawn (in units of blocks)
